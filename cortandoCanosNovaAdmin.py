...
def findMaxPrice(size_limit, pipes, prices, num_pipes):  # mochila booleana
    ...
    if (pipes[num_pipes - 1] > size_limit):
        ...
        a = prices[num_pipes - 1] + findMaxPrice(size_limit - pipes[num_pipes - 1], pipes, prices, num_pipes - 1)
        b = findMaxPrice(size_limit, pipes, prices, num_pipes - 1)
        return findHighestNumber(a,b)
